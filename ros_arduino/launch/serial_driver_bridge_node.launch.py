...
def generate_launch_description():
    #share_dir = get_package_share_directory('ros_arduino')    
   ...
   # println(share_dir)
    params_declare = DeclareLaunchArgument(
        'params_file',
        default_value='/home/lloyd/cart_ws/src/practical_robot_tools/ros_arduino/params/serial_driver_bridge_params.yaml',
    ...
    bridge_node = LifecycleNode(
        ...
        remappings=[("serial_write", "arduino_cmd_msg")],
        output='screen',
    )
