...
// template <>
// bool serialize(MessageType type, std::vector<bool> &data, std::vector<uint8_t> &packet)
// {
...
template bool serialize<bool>(MessageType type, std::vector<bool> &data, std::vector<uint8_t> &packet);
template bool serialize<int8_t>(MessageType type, std::vector<int8_t> &data, std::vector<uint8_t> &packet);
template bool serialize<uint8_t>(MessageType type, std::vector<uint8_t> &data, std::vector<uint8_t> &packet);
template bool serialize<int16_t>(MessageType type, std::vector<int16_t> &data, std::vector<uint8_t> &packet);
template bool serialize<int32_t>(MessageType type, std::vector<int32_t> &data, std::vector<uint8_t> &packet);
